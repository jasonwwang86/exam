...
@Transactional
class AdminPaperQuestionControllerTest {
    ...
    @Test
    void shouldCreatePaperQuestions() throws Exception {
        String token = loginAndExtractToken("admin", "Admin@123456");
    ...
    @Test
    void shouldUpdatePaperQuestion() throws Exception {
        String token = loginAndExtractToken("admin", "Admin@123456");
        ...
        mockMvc.perform(put("/api/admin/papers/1/questions/2")
                ...
                .andExpect(jsonPath("$.itemScore").value(9.5))
                .andExpect(jsonPath("$.displayOrder").value(1));
    }

    @Test
    void shouldDeletePaperQuestion() throws Exception {
        String token = loginAndExtractToken("admin", "Admin@123456");
